 ...
 */
const ClassicalNoise = function ClassicalNoiseFn(this: any, r?: any) {
...
ClassicalNoise.prototype.dot = function (g: any, x: any, y: any, z: any) {
  return g[0] * x + g[1] * y + g[2] * z;
};

ClassicalNoise.prototype.mix = function (a: any, b: any, t: any) {
  return (1.0 - t) * a + t * b;
};

ClassicalNoise.prototype.fade = function (t: any) {
  return t * t * t * (t * (t * 6.0 - 15.0) + 10.0);
};

// Classic Perlin noise, 3D version
ClassicalNoise.prototype.noise = function (x: any, y: any, z: any) {
